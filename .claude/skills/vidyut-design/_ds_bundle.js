...
const DS3 = window.VidyutDesignSystem_5c35fc;
function HomeScreen({
  paired,
  onPair,
  onReset,
...
function SetupChecklistScreen({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(window.AppBar, {
    ...
    detail: "Vidyut stays connected while the phone sleeps."
  })), /*#__PURE__*/React.createElement(Entrance, {
    index: 3
  }, /*#__PURE__*/React.createElement(window.ChecklistRow, {
    ok: allOk,
...
const DS2 = window.VidyutDesignSystem_5c35fc;
...
const wizardSteps = [{
  ...
  body: "Vidyut shows a small ongoing notification while sync runs, and a quiet receipt when something arrives from your laptop.",
  consequence: "You won't see receipts when the laptop sends you things.",
  primaryLabel: "Allow"
}, {
  icon: "photo_library",
  title: "Spot your screenshots",
  body: "To send screenshots automatically, Vidyut needs access to all photos. Pick Allow all — with 'Select photos' it can't see new screenshots.",
  ...
  body: "Android puts idle apps to sleep, which drops the connection to your laptop. Allow Vidyut to ignore battery optimizations so payloads arrive even when the screen is off.",
