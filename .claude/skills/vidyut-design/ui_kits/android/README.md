# Vidyut Android UI Kit

Interactive recreation of the Vidyut Android app (Flutter, Material 3, "Flat Raspberry Pink" theme). Source of truth: `app/lib/src/` in https://github.com/Snehit70/vidyut.
