...
class ClipboardAutoSendPlugin :
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        methodChannel =
            MethodChannel(binding.binaryMessenger, "imagesync/clipboard_autosend")
        methodChannel.setMethodCallHandler(this)
        eventChannel =
            EventChannel(binding.binaryMessenger, "imagesync/clipboard_autosend_events")
...
object ClipboardAutoSendWatcher {
    ...
    private fun startLogcat(context: Context, filter: String) {
        ...
        }, "imagesync-clipboard-autosend-logcat")
