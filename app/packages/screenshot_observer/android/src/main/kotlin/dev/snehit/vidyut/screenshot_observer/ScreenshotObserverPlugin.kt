package dev.snehit.vidyut.screenshot_observer
...
class ScreenshotObserverPlugin :
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        methodChannel =
            MethodChannel(binding.binaryMessenger, "vidyut/screenshot_observer")
        methodChannel.setMethodCallHandler(this)
        eventChannel =
            EventChannel(binding.binaryMessenger, "vidyut/screenshot_events")
...
object ScreenshotWatcher {
    ...
    fun start(context: Context) {
        ...
        val thread = HandlerThread("vidyut-screenshot-observer").apply { start() }
    ...
    private fun readHandler(): Handler {
        ...
        val thread = HandlerThread("vidyut-screenshot-reader").apply { start() }
